...
class DescriptionGenerator:
    ...
    def switch_model(self, model_type: str):
        ...
        if model_type == self.model_type and self.model is not None:
            print(f"ℹAlready using {model_type} model")
            return
    ...
    def generate_description(
        ...
        Args:
            detections: List of face detection and emotion analysis results
    ...
    def _generate_flan_t5(
        ...
        # LLM_CONFIG has been defined in the config file
    ...
    def _generate_mistral(
        ...
        """
        Generates natural language description from face detections and emotinal analysis.
